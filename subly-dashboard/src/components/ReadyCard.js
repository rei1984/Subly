...
const ReadyCard = ({name, cover, languages, status, createdAt, updatedAt}) => {
    ...
    return (
        <>
            <Card style={{ width: '25rem', height: 'auto' }} onMouseEnter={(e) => (setHovering(true))} onMouseLeave={(e) => (setHovering(false))}>
                ...
                <Card.ImgOverlay >
                    ...
                    {hovering ? <>
                    <Button style={{ width: '34%', height: '44px', marginRight: '33%', marginLeft: '33%'}} variant= 'outline-light' as="Edit" type="button">Edit</Button>
